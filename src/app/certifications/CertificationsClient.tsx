    ...
    <div className="w-full select-none space-y-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {certifications.map((cert) => (
          <div
            key={cert.name}
            className="p-4 sm:p-5 rounded-xl bg-surface/25 border border-border-hairline hover:bg-surface/60 transition-all duration-200 flex flex-col justify-between group shadow-2xs relative overflow-hidden"
          >
            ...
            <div className="pt-3 mt-3 border-t border-border-hairline flex items-center justify-between gap-2">
              {cert.code ? (
