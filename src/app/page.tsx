              ...
              >
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] font-mono font-bold uppercase tracking-wider text-text-secondary dark:text-dark-text-secondary">
                      Community Member
                    </span>
                  </div>
                  ...
                  <p className="text-[11px] text-text-muted dark:text-dark-text-muted leading-relaxed">
                    Active member of Google Developer Groups Zamboanga Region,
                    collaborating and sharing web technologies.
                  </p>
                </div>
              </a>
            </div>
