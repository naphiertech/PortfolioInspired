        ...
        >
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            >
              ...
              <span className="font-mono text-xs text-muted-foreground group-hover:text-ink">
                LinkedIn
              </span>
            </a>
        ...
        >
          ...
          <div className="space-y-2 font-mono text-xs">
            ...
            >
              ...
              <span className="text-muted-foreground/75 text-xs">email</span>
            </a>
            ...
            >
              ...
              <span className="text-muted-foreground/75 text-xs">download</span>
            </a>
          </div>
        </motion.div>
      </motion.div>
